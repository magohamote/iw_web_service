...
def create_user_charac_dict(user_vector):
    user_dict = dict()
    user_dict["intensity"] = (user_vector["intensity1"], user_vector["intensity2"], user_vector["intensity3"], user_vector["intensity4"], user_vector["intensity5"])
    ...
    user_dict["finish"] = (user_vector["finish1"], user_vector["finish2"], user_vector["finish3"], user_vector["finish4"], user_vector["finish5"])

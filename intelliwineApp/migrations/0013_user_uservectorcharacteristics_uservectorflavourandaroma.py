# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-06-19 16:00
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('intelliwineApp', '0012_auto_20160617_1429'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='UserVectorCharacteristics',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('user_foreign_key', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, related_name='charac', to='intelliwineApp.User')),
            ],
        ),
        migrations.CreateModel(
            name='UserVectorFlavourAndAroma',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('user_foreign_key', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, related_name='flav_aroma', to='intelliwineApp.User')),
            ],
        ),
    ]
